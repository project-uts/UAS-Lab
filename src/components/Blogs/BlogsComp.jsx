...
const BlogsData = [
  {
    ...
    title: "Baju Gothil",
    description:
      "Baju Gothil atau warok ponorogo merupakan pakaian adat Jawa Timur in dipakai oleh para pria. Pakaian tradisional ini memiliki warna yang kkhas yakni hitam polos dengan ukuran longgar serta lengan panjang. Baju adat ini memiliki pasangannya, yakni Celana Komprang yang ukurannya besar dan longgar saat dipakai seolah memberi ruang pada penggunanya untuk menikmati ruang gerak. Bentuk celana ini pun cukup unik, ditambah lagi celana ini dijahit dengan teknik khusus.",
  },
  {
    id: 2,
    image: Img2,
  ...
  },
  {
    ...
    description:
      "Pakaian ini pun memiliki motif sederhana dan biasanya terbuat dari kain tipis dan menerawang, seperti brokat. Agar kebaya ini nampak serasi dengan bawahannya, wanita Madura mengenakan kain batik yang dikenakan seperti rok panjang.",
  },
];
  ...
  return (
    <div>
      ...
      {popupData && (
        ...
        >
          <div
            className="bg-white p-4 rounded-lg max-w-lg relative"
