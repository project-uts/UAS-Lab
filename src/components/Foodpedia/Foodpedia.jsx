...
const FoodpediaData = [
  ...
  },
  {
    ...
    title: "Lontong Balap",
    description:
      "makanan Jawa Timur yang berasal dari Surabaya, yaitu lontong balap. Makanan ini diracik dengan lontong, taoge, tahu goreng, lentho, serta diberi sedikit kecap manis, bawang goreng, dan sambal. Lentho sendiri adalah gorengan yang terbuat dari kacang tolo.",
  },
  {
    id: 4,
    img: Img4,
  ...
  },
  {
    ...
    title: "Tahu Tek",
    description:
      "Makanan ini berbahan dasar tahu sesuai namanya. Makanan khas Jawa Timur ini kemudian ditambahkan dengan lontong, taoge, dan acar. Tak lupa, hidangan tahu tek disiram dengan bumbu kacang petis yang menggugah selera.",
  },
  {
    id: 7,
    img: Img7,
  ...
  },
  {
    ...
    title: "Rujak Soto",
    description:
      "hidangan ini merupakan perpaduan antara kuah soto dan beberapa isian rujak cingur yang khas yakni petis dan pisang batu. Rasanya yang bercampur membuat makanan ini menyegarkan. Makanan khas Banyuwangi ini juga berisi potongan daging sapi dan babat",
  },
];
